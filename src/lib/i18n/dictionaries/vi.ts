...
const vi: Dictionary = {
  ...
  admin: {
    ...
    dateRangeFromLabel: "Từ ngày",
    dateRangeToLabel: "Đến ngày",
    dateRangeApply: "Lọc",
    dateRangeNote: "Nếu không chọn, mặc định chỉ hiển thị dữ liệu của tháng này.",
    showMoreButton: "Xem thêm",
    countLabel: (n: number) => `Số lượng hiển thị: ${n}`,
    countLabelVisible: (visible: number, total: number) => `Đang hiển thị ${visible} / ${total}`,
  ...
  employees: {
    ...
    footnote:
      'Hãy "Xóa" nhân viên không còn sử dụng (sẽ bị ẩn khỏi danh sách chọn khi đặt xe). Dữ liệu đặt xe trước đây vẫn được giữ lại dưới dạng tên đã ghi nhận, không bị xóa.',
    delete: "Xóa",
    deleteConfirm: (name: string) => `Bạn có chắc muốn xóa "${name}"?\nSẽ bị ẩn khỏi danh sách chọn khi đặt xe (dữ liệu đặt xe trước đây không bị xóa). Không thể hoàn tác.`,
  ...
  apiErrors: {
    ...
    deleteEmployeeFailed: "Xóa nhân viên không thành công.",
